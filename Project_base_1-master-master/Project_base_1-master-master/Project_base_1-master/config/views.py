...
def goHome(request):
    ...
    return render(request, 'archone/home.html')
...
def guide(request):
    ...
    return render(request, 'archone/guide.html')

def example(request):

    return render(request, 'archone/example.html')

def logo_making(request):
...
def result(request):
    if request.method == 'GET':
        ...
        return render(request, 'archone/result.html', {'color1' : color[0], 'color2' : color[1], 'color3' : color[2], 'choice' : choice})

def edit(request):

    return render(request, 'archone/edit.html')
